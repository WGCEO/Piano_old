    ...
    func checkCoreData() {
        do {
            ...
            if folderCount == 0 {
                ...
                let content =  NSAttributedString(string: "PianoTutorial".localized(withComment: "피아노 튜토리얼 내용"), attributes: [NSFontAttributeName : UIFont.preferredFont(forTextStyle: .body)])
